 ...
 */
package com.extraditables.los.brokin.navigation;
...
public class Navigator {
     ...
     */
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN) public void goToList(Activity activity) {
        activity.navigateUpTo(new Intent(activity, MainTabbedActivity.class));
    }
    ...
    public void goToDetail(Activity activity, int comicId) {
        if (activity != null) {
            Intent intentToLaunch = StockInfoActivity.getCallingIntent(activity, comicId);
